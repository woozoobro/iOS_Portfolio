...
//  SwiftfulThinkingMaster_Tests
//
//  Created by 우주형 on 2023/04/08.
//

import XCTest
@testable import SwiftfulThinkingMaster
import Combine
...
final class NewMockDataService_Tests: XCTestCase {
    ...
    func test_NewMockDataService_downloadItemsWithCombine_doesFail() {
        ...
        let expectation2 = XCTestExpectation(description: "Does Throw URLErrror.badServerResponse")
